# 30-dagarserbjudandet — ett rekommenderat upplägg
**"Artikelsanningen" · fast pris · designat för att bevisa värde snabbt och konvertera till löpande**

## Trappan
```
Steg 0 (gratis, direkt efter mötet): EN artikel, fyra fält → en sida på en vecka
Steg 1 (detta erbjudande):          hela Asienflödet, 30 dagar, 95 000 SEK fast
Steg 2 (konvertering):              löpande trade-operator, 25–40 000 SEK/mån
```
...
> **"Hittar vi inte minst 95 000 kr i dokumenterad effekt betalar ni ingenting."**
> **Definition (samma mening överallt, även i avtalet):** *garantin utlöses av dokumenterade avvikelser med belopp och rättslig grund — årliga eller engångs (återbetalningar räknas), i er favör eller er risk — oavsett om ni väljer att åtgärda dem.* Att en funnen avvikelse ligger åt fel håll är också värde: självrättelse med lindring i stället för tulltillägg vid revision (jfr invändning 15).

95 000 SEK ≈ 0,24 % av ESMA:s rörelseresultat; Big 4 offererar motsvarande på 250–500 kSEK; en CBAM-SaaS kostar 100–250 kSEK/år utan att någon gör själva arbetet. Garantins täckning: massaavstämning + scope-differens + AD-/preferenskontroll brukar nå ≥95 kSEK på ett flöde av denna storlek — men **ett rent ESMA är ett äkta förlustscenario för oss** (jfr pre-mortem: ISO 14001 sedan 2006, Intertek-reviderat). Det är medvetet: risken är vår, och det är därför garantin är trovärdig. **Metodbevis, sägs så här:** *"Det här är samma arbete vi gör löpande åt en svensk stålimportör i dag — klassificering, förfaranden, producentmappning, leverantörsdata."* **Inga orealiserade besparingar beskrivs som resultat — aldrig.**
