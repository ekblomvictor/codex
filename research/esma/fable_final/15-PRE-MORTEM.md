# Pre-mortem — fredagen gick dåligt. Varför?
**Anta artig avfärdning kl. 13.20. Orsaker, sannolikhet, motåtgärd.**

| # | Dödsorsak | Sann. | Motåtgärd (görs FÖRE mötet) |
|---|---|---|---|
| 1 | Förklarade CBAM för CBAM-ansvarige | Hög | Öppningen säger uttryckligen att vi inte ska; håll det |
| 2 | Överdrev 2026-kostnaden | Hög | Säg **~100 kSEK** tidigt — trovärdighetskortet |
| 3 | Sa något ur DONT-SAY (marginalpress, Kina-ansvarig, 7,7 MUSD, ≤6 mm, 16 MSEK) | Medel | Läs 05-DONT-SAY på morgonen; liveguiden öppen |
| 4 | Bad om leverantörslistan / för mycket data | Medel-hög | Föregrip: "A, B, C räcker"; be om FYRA fält |
| 5 | Tesen föll: agentur, inte egen import | ~20 % | Nollfrågan tidigt; reservspår A (kunddata/PCF) redo |
| 6 | De har redan tullager | ~30 % | Reservspår B: population-vs-förfarande + AD-satser — *fortfarande vårt jobb*; gratulera först |
| 7 | Pitchade sourcing/QA — deras egen affär | Låg om manus följs | Förbudslistan i 11-OPPORTUNITY; ESMA ÄR trade-operatorn åt sina kunder |
| 8 | Försökte stänga 95 kSEK direkt | Medel | Close = fyra fält. Punkt. Steg 1 säljs på uppföljningen |
